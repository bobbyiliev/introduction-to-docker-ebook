...
* **Diese Version wurde am October 27 2022 veröffentlicht**

Dies ist eine Open-Source-Einführung in Docker, die Ihnen helfen wird, die Grundlagen von Docker zu erlernen und Container für Ihre SysOps-, DevOps- und Dev-Projekte zu verwenden. Unabhängig davon, ob Sie ein DevOps/SysOps-Ingenieur, Entwickler oder einfach nur ein Linux-Enthusiast sind, werden Sie höchstwahrscheinlich irgendwann in Ihrer Karriere mit Docker arbeiten müssen.

Das Handbuch ist für jeden geeignet, der als Entwickler, Systemadministrator oder DevOps-Ingenieur arbeitet und die Grundlagen von Docker erlernen möchte.
...
[Materialize](https://materialize.com/) ist eine reaktive Datenbank, die inkrementelle Aktualisierungen von Ansichten liefert. Materialize unterstützt Entwickler bei der einfachen Erstellung von Streaming-Daten mit Standard-SQL.
### DigitalOcean
...
Das Unternehmen bietet hochverfügbare, sichere und skalierbare Rechen-, Speicher- und Netzwerklösungen, mit denen Entwickler schneller großartige Software entwickeln können.
...
[Kostenloses $100-Guthaben für DigitalOcean](https://m.do.co/c/2a9bba940f39)
...
Dieses ebook wurde mit [Ibis](https://github.com/themsaid/ibis/) erstellt, entwickelt von [Mohamed Said](https://github.com/themsaid).

Ibis ist ein PHP-Tool, mit dem Sie eBooks in Markdown schreiben können.
